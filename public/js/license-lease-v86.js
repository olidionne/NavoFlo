(() => {
  ...
  function card(inner){ gate.innerHTML=`<div class="nlg-card">${inner}</div>`; gate.hidden=false; document.body.classList.add('navoflo-license-locked'); locked=true; }
  ...
  function unlock(){ clearLoadingWatchdog(); gate.hidden=true; document.body.classList.remove('navoflo-license-locked'); locked=false; }
